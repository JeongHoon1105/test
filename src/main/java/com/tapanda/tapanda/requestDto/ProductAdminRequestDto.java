...
public class ProductAdminRequestDto {
    ...
    private List<PaidOptionRequestDto> paidOptionList;

    public List<PaidOptionRequestDto> getPaidOptionList() { return paidOptionList; }

    private List<FaqRequestDto> faqList;

    public List<FaqRequestDto> getFaqList() { return faqList; }

    private List<VideoRequestDto> videoList;

    public List<VideoRequestDto> getVideoList() { return videoList; }
