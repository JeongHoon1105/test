...
public class PortfolioUpdateException extends RuntimeException {
    ...
    public PortfolioUpdateException(String resourceName, String errorMessage, Object fieldValue) {
        super(String.format("PortfolioUpdateException resourceName: [%s], errorMessage: [%s], fieldValue: [%s]",
