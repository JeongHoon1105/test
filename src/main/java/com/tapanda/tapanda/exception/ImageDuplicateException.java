...
public class ImageDuplicateException extends RuntimeException {
    ...
    public ImageDuplicateException(String resourceName, String errorMessage, Object fieldValue) {
        super(String.format("ImageDuplicateException resourceName: [%s], errorMessage: [%s], fieldValue: [%s]",
