...
public class IndividualNotFoundException extends RuntimeException {
    ...
    public IndividualNotFoundException(String resourceName, String errorMessage, Object fieldValue) {
        super(String.format("ImageNotFoundException resourceName: [%s], errorMessage: [%s], fieldValue: [%s]",
