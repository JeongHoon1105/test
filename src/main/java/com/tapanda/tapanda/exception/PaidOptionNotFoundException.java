...
public class PaidOptionNotFoundException extends RuntimeException {
    ...
    public PaidOptionNotFoundException(String resourceName, String errorMessage, Object fieldValue) {
